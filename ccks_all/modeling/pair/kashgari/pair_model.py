...
class PairClassificationModel(BaseModel):
    ...
    def __init__(self,
        ...
        :param kwargs:
        """
        super(PairClassificationModel, self).__init__(embedding, hyper_parameters, **kwargs)
    ...
    def info(self):
        info = super(PairClassificationModel, self).info()
    ...
    def load_model(cls, model_path: str):
        agent: PairClassificationModel = super(PairClassificationModel, cls).load_model(model_path)
