...
def build_model(lr=0.0, lr_d=0.0):
    ...
    x_a = Embedding(20001, embed_size, weights=[embedding_matrix], trainable=False)(inp_a)
    x_b = Embedding(20001, embed_size, weights=[embedding_matrix], trainable=False)(inp_b)
    ...
    model.fit([X_train_a, X_train_b], y_ohe, batch_size=32, epochs=20, validation_split=0.3, verbose=1,
